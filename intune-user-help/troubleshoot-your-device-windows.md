---
title: Windows-eszközök gyakori problémáinak elhárítása | Microsoft Docs
description: Módszerek a Windows-eszközökkel gyakran előforduló problémák megoldására.
keywords: ''
author: lenewsad
ms.author: lanewsad
manager: dougeby
...
- [Engedélyeznem kell a biztonságos rendszerindítást](you-need-to-enable-secure-boot-windows.md)
- [Engedélyeznem kell a Kódintegritást](you-need-to-enable-code-integrity.md)
