...
- [Hiba történt egy macOS rendszerű virtuális gép regisztrálásakor](unable-to-get-macOS-device-managed.md)  
- [„A macOS-eszközön sorozatszáma korlátozott” típusú üzenetet kaptam](unable-to-get-macOS-device-managed.md)  
- [Az eszközöm máshoz lehet rendelve](unable-to-get-macOS-device-managed.md)  
