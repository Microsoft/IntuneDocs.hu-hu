...
A sötét üzemmódot az iOS-Céges portál tervezték. Töltse le a vállalati alkalmazásokat, kezelje az eszközöket, és szerezze be támogatását az Ön által választott színsémában. További információ az iOS Céges portálről: [a Microsoft Intune céges portál alkalmazás konfigurálása](../apps/company-portal-app.md).
