...
Ez a cikk a szervezeti erőforrások elérésére vonatkozó gyakori hibákat, állapotkódot, leírásokat és lehetséges megoldásokat sorolja fel. Ezekkel az információkkal a Microsoft Intune használatakor felmerülő hozzáférési problémák elhárításához nyújt segítséget.

Ha támogatási segítségre van szüksége, tekintse meg [a Microsoft Intune támogatásának beszerzése](../get-support.md)című témakört.
...
A [Microsoft Intune támogatásához](../get-support.md)vegye fel a kapcsolatot Microsoft ügyfélszolgálata.
