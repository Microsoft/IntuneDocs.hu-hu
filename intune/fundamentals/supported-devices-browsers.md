...
> [!NOTE]
> Az Intune mostantól Android 5. x (nyalóka) vagy újabb verzió szükséges ahhoz, hogy az alkalmazások és eszközök hozzáférjenek a vállalati erőforrásokhoz az Android rendszerhez készült Céges portál alkalmazással és az Androidhoz készült Intune app SDK-val. Ez a követelmény nem vonatkozik az Polycom Android-alapú Teaming-eszközök 4,4-es verzióját futtató eszközeire. Ezek az eszközök továbbra is támogatottak lesznek. 
