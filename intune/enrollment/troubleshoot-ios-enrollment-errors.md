...
#### <a name="resolution"></a>Megoldás
Hozza létre a megfelelő CNAME DNS-erőforrásrekordokat a céges tartományhoz. For example, if your company’s domain is contoso.com, create a CNAME in DNS that redirects EnterpriseEnrollment.contoso.com to EnterpriseEnrollment-s.manage.microsoft.com.
...
If there's more than one verified domain, create a CNAME record for each domain. A CNAME erőforrásrekordoknak a következő adatokat kell tartalmazniuk:
...
2. Synchronize DEP-managed devices: Open the Intune portal > **Admin** > **Mobile Device Management** > **iOS** > **Device Enrollment Program** > **Sync now**. A szolgáltatás elküld egy szinkronizálási kérelmet az Apple-nek.
