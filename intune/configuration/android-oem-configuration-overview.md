...
Ha létezik egy OEMConfig-alkalmazás az eszközhöz, de nem szerepel a fenti táblázatban, vagy nem jelenik meg az Intune-konzolon, kérjük, küldjön e-mailt `IntuneOEMConfig@microsoft.com`.
