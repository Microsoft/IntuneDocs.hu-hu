...
3. A CSV-fájl neve lesz a mobil előfizetési készlet neve a Endpoint Manager felügyeleti központban. Az előző képen a fájl neve `UnlimitedDataSkynet.csv`. Tehát az Intune ezt a nevet adja az `UnlimitedDataSkynet.csv` előfizetés-készletnek:
