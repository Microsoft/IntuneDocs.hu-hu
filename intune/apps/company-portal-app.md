...
> [!IMPORTANT]
> A Google Firebase Cloud Messaging (FCM) támogatásához frissítenie kell az Android Céges portál alkalmazást a legújabb verzióra. További információ: Újdonságok – [Android céges portál-alkalmazás frissítése a legújabb verzióra](../fundamentals/whats-new.md#update-your-android-company-portal-app-to-the-latest-version-).
