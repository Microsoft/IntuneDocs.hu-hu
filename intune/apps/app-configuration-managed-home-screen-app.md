...
| A mappában lévő alkalmazások a név szerint vannak rendezve | Bool | IGAZ | A beállítás bekapcsolásával `False` lehetővé teszi, hogy a mappában lévő elemek a megadott sorrendben jelenjenek meg. Ellenkező esetben a mappában betűrendben fog megjelenni.   |
