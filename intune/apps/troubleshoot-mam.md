...
**Nem lehet regisztrálni az alkalmazást**: Ezt az alkalmazást Microsoft Intune kell felügyelni, de most nem sikerült regisztrálni az alkalmazást. Segítségért forduljon a rendszergazdához. | Nem sikerült automatikusan regisztrálni az alkalmazást a MAM-szolgáltatásban, pedig alkalmazásvédelmi szabályzatra van szükség. | Törölje az alkalmazásadatokat. <br><br> Naplókat küldhet az Intune-nak a Céges portál alkalmazáson keresztül, vagy egy támogatási jegyet. További információkért lásd: [a Microsoft Intune támogatásának](../fundamentals/get-support.md)beszerzése.
