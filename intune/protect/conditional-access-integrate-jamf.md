---
title: A JAMF Pro integrálása Microsoft Intune a megfelelőség érdekében
...
- [Céges portál alkalmazás macOS rendszerhez](https://aka.ms/macoscompanyportal)
- macOS-eszközök OS X 10,11 Yosemite vagy újabb verzióval
...
## <a name="enable-intune-to-integrate-with-jamf-pro"></a>Az Intune-nal való integrálás engedélyezése a JAMF Pro-val
...
## <a name="configure-microsoft-intune-integration-in-jamf-pro"></a>Microsoft Intune integráció konfigurálása a JAMF Pro-ban

1. A JAMF Pro-ban navigáljon a **globális felügyelet**@no__t – 1**feltételes hozzáférés**elemre. Kattintson a **Szerkesztés** gombra a **MacOS Intune-integráció** lapon.
...
- [Megfelelőségi szabályzatok alkalmazása JAMF által felügyelt eszközökre](conditional-access-assign-jamf.md)
