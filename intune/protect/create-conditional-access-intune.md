...
10. A **Hozzáférés-vezérlés** alatt válassza ki az **Engedélyezés** elemet. Configure what happens based on the conditions you’ve set up.  You can select from the following options:
