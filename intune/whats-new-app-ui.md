...
- Az egyéni leküldéses értesítések megjelenítése, az alkalmazás igazítása az iOS és Android rendszerhez készült Céges portál alkalmazásban nemrégiben hozzáadott támogatással. További információt [az egyéni értesítések küldése az Intune-ban](custom-notifications.md)című témakörben talál.
    ...
    Felhasználói profil példája:<br>
...
![Képernyőkép a Céges portál webhely, telepített alkalmazások oldaláról.](/intune-user-help/media/intune-installed-apps-1907.png)     
...
![Példa a Windows 10 rendszerhez készült Céges portál alkalmazás képernyőképére, a telepített alkalmazások oldalára. ](/intune-user-help/media/installed-apps-cp-1906.png)  
...
### <a name="new-end-user-app-microsoft-intune-app---3903244---"></a>Új végfelhasználói alkalmazás (Microsoft Intune alkalmazás) <!--3903244 -->  
...
![Képernyőkép a Microsoft Intune alkalmazásról, amely a Jane androidos eszközének adatait jeleníti meg.](./media/1904-intune-app-device-details.png)   

Példa a **telepítési hozzáférési** képernyő képernyőképére:  

![Képernyőkép a Microsoft Intune alkalmazásról, amely a telepítő hozzáférés beléptetése képernyőt mutatja.](./media/1904-intune-app-setup-access.png)   

Példa az alkalmazás menü képernyőképére:  

![Képernyőkép a Microsoft Intune alkalmazásról, amely az oldalsó menüt mutatja.](./media/1904-intune-app-navigation-menu.png)   

Példa a **Súgó** képernyő képernyőképére:  

![Képernyőkép a Microsoft Intune alkalmazásról, a Súgó képernyőről.](./media/1904-intune-app-help.png)   
...
## <a name="week-of-february-19-2019"></a>2019. február 19. hét  
### <a name="new-app-categories-screen-in-the-company-portal-app-for-windows-10---3834780-wnready4review---"></a>Új alkalmazás-kategóriák képernyő a Windows 10-es Céges portál alkalmazásban<!-- 3834780 WNready4Review -->  
...
![Képernyőkép a Windows 10-es Céges portálról, az alkalmazások kategóriái képernyőn.](./media/1902_CP_app_categories.png)   
...
### <a name="company-portal-for-android-visual-updates----976944---"></a>Céges portál androidos vizuális frissítésekhez <!-- 976944 -->
...
### <a name="new-device-categories-step-in-guided-setup-for-the-company-portal-app-for-windows-10----1335292---"></a>Új "eszközök kategóriái" lépés a Windows 10-es Céges portál alkalmazásának irányított beállítása című témakörben <!-- 1335292 -->
...
### <a name="search-improvements-to-the-company-portal-apps-and-website----1418189---"></a>Keresés a Céges portál alkalmazások és webhelyek terén <!-- 1418189 -->
...
### <a name="ios-company-portal-displays-large-icons----1454593---"></a>az iOS Céges portál nagyméretű ikonokat jelenít meg <!-- 1454593 -->
...
### <a name="ios-11-mail-app-will-support-oauth----1196951---"></a>az iOS 11 mail alkalmazás támogatni fogja a OAuth <!-- 1196951 -->
...
### <a name="intune-mobile-application-management-mam-dialog-boxes-will-have-a-modern-interface----1199015---"></a>Az Intune Mobile Application Management (MAM) párbeszédpaneljei modern felületet kapnak <!-- 1199015 -->
...
### <a name="apps-details-pages-will-display-new-information-for-android-devices---1287476--"></a>Az alkalmazások részleteit tartalmazó lapok új információkat jelenítenek meg az Android-eszközökhöz <!--1287476-->
...
### <a name="improvements-to-the-app-tiles-in-the-company-portal-app-for-ios---1230777--"></a>Továbbfejlesztett alkalmazáscsempék az iOS-es Céges portál alkalmazásban <!--1230777-->
...
### <a name="new-icons-for-the-managed-browser-and-the-company-portal---918433-918431--"></a>A Managed Browser és a Céges portál új ikonjai <!--918433, 918431-->
...
### <a name="new-user-experience-for-the-company-portal-app-for-android---621622-announced-1702--"></a>Új felhasználói élmény az Android rendszerhez készült Céges portál alkalmazáshoz <!--621622, announced 1702-->
