...
A [tanúsítványok](certificates-configure.md) az eszközökhöz rendelt megbízható, SCEP és PKCS tanúsítványokat konfigurálják. Ezek a tanúsítványok a Wi-Fi-, VPN-és e-mail-profilokat hitelesítik.
...
Az [Oktatási beállítások – iOS](education-settings-configure-ios-shared.md) az iOS-es Osztályterem alkalmazás segítségével lehetővé teszi az oktatási folyamat és a diákok eszközeinek irányítását az osztályteremben. Az iPad eszközöket úgy is konfigurálhatja, hogy sok diák megoszthat egyetlen eszközt.
