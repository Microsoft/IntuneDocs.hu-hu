...
> [!IMPORTANT]
> Az alkalmazás-alapú feltételes hozzáférési szabályzatok használata előtt az alkalmazásokra alkalmaznia kell az [Intune app Protection-szabályzatokat](app-protection-policies.md) .
