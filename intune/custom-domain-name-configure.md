...
3. Kattintson a **Tartomány felvétele** gombra, és írja be az egyéni tartománynevet. Kattintson a **Tovább** gombra.
   ![Képernyőkép a Microsoft 365 felügyeleti központ beállításairól > a kiválasztott tartományok és új tartománynév hozzáadása](./media/domain-custom-add.png)
...
5. [Előfordulhat, hogy további DNS-rekordokat kell létrehoznia az Intune-regisztrációhoz](windows-enroll.md#simplify-windows-enrollment-without-azure-ad-premium).
...
Ha szeretne többet megtudni arról, hogyan [egyszerűsítheti a Windows-regisztrációt prémium szintű Azure ad nélkül](windows-enroll.md#simplify-windows-enrollment-without-azure-ad-premium) , hozzon létre egy DNS-CNAME-t, amely átirányítja a regisztrációt az Intune-kiszolgálókra.
