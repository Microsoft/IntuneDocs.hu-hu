...
- **Hitelesítési módszer**: Válassza ki, hogy az eszközök hogyan legyenek hitelesítve a VPN-kiszolgálóval. 
  - **Tanúsítványok**: A **hitelesítési tanúsítvány**területen válasszon ki egy meglévő SCEP-vagy PKCS-tanúsítvány-profilt a kapcsolódás hitelesítéséhez. A [Tanúsítványok konfigurálása](certificates-configure.md) című témakörben találhat útmutatást a tanúsítványprofilokról.
