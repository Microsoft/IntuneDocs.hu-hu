...
|**Android-eszköz rendszergazdája a zebra Mobility Extensions bővítménnyel**|**Céges portál használatával kezdeményezett felhasználó vagy [DEM](#device-enrollment-manager)**| Nem | Igen, ha a felhasználó kezdeményezte, nem, ha a [DEM](#device-enrollment-manager) kezdeményezte | Nem | [További információ](./android-zebra-mx-overview.md)|
